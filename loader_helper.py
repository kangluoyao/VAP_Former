...
class LoaderHelper:
    ...
    def __init__(self, task: Task = Task.NC_v_AD):
        ...
        #cat12
        self.train_ds = MRIDataset(root_dir="/data2/public_data/ADNI_new/adni_data/adni1/",
                labels=self.labels,
                training=True,
                transform=transforms.Compose([
                ToTensor()
            ]))
        self.test_ds = MRIDataset(root_dir="/data2/public_data/ADNI_new/adni_data/adni2/",
                labels=self.labels,
                training=False,
                transform=transforms.Compose([
                ToTensor()
